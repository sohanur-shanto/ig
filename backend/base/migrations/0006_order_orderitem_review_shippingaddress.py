    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('CANCEL', 'Cancel'), ('PENDING_PAYMENT', 'Pending Payment'), ('ON_HOLD', 'On Hold'), ('WAITING_FOR_PAYMENT', 'Waiting For Payment'), ('PROCESSING', 'Processing'), ('COMPLETE', 'Complete')], default='PENDING_PAYMENT', max_length=220)),
